...
const App = () => {
	...
	const fetchTotalData = async () => {
		...
		const { data } = await axios.get('https://api.rootnet.in/covid19-in/unofficial/covid19india.org/statewise');
...

 {
		...
		const { data } = await axios.get('https://cryptic-ravine-96718.herokuapp.com/');
