...
import {faFacebookF,faInstagram,faGithub} from
'@fortawesome/free-brands-svg-icons';

const Footer = () => {
	return(
	<div>
	<footer className="page-footer blue-grey" style={{borderRadius:"20px",textAlign:"center",fontFamily: "'Balsamiq Sans', cursive"}}>
	 ...
	 <div className="col l6 s12"> 
	  <h5 className="grey-text text-lighten-4">Code with ❤ by Saurabh</h5>
	  </div> 
	  <div className="col l4 offset-l2 s12"> 
	  <h6>API Credits:-<a href="https://github.com/amodm/api-covid19-in">Amod Malviya & </a>
	  <a href="https://coronews.iamharsh.design/">iamharsh.dev</a>
	  </h6>
	  <h6>Data:-The Ministry of Health and Family Welfare</h6>
	  <h6>
	  Stay Home Stay Safe <span role="img" aria-label="mask">😷</span>
	  </h6>
	    </div> 
	    </div> 
	    </div> 
	    <div className="footer-copyright blue-grey"> 
	    <div className="container"> © 2020 Saurabh Sonde
	    </div> 
	    </div>
	     </footer> 
	</div>
